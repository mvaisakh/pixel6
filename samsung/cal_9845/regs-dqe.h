...
#define DQE0_ATC_CONTROL		(0x0400)
...
#define DQE0_ATC_PARTIAL_IBSI_P2	(0x043C)
...
#define DQE0_HSC_CONTROL		(0x0800)
...
#define DQE0_HSC_LOCAL_CONTROL		(0x0804)
...
#define DQE0_HSC_CONTROL_ALPHA_BRI	(0x0818)
 ...
 * _n : [0, 2]
 */
#define DQE0_HSC_CONTROL_MC1_R(_n)	(0x081C + ((_n) * 4 * 0x4))
#define DQE0_HSC_CONTROL_MC2_R(_n)	(0x0820 + ((_n) * 4 * 0x4))
#define DQE0_HSC_CONTROL_MC3_R(_n)	(0x0824 + ((_n) * 4 * 0x4))
#define DQE0_HSC_CONTROL_MC4_R(_n)	(0x0828 + ((_n) * 4 * 0x4))
...
#define DQE0_HSC_CONTROL_MC1_R0		(0x081C)
#define DQE0_HSC_CONTROL_MC2_R0		(0x0820)
#define DQE0_HSC_CONTROL_MC3_R0		(0x0824)
#define DQE0_HSC_CONTROL_MC4_R0		(0x0828)

#define DQE0_HSC_CONTROL_MC1_R1		(0x082C)
#define DQE0_HSC_CONTROL_MC2_R1		(0x0830)
#define DQE0_HSC_CONTROL_MC3_R1		(0x0834)
#define DQE0_HSC_CONTROL_MC4_R1		(0x0838)

#define DQE0_HSC_CONTROL_MC1_R2		(0x083C)
#define DQE0_HSC_CONTROL_MC2_R2		(0x0840)
#define DQE0_HSC_CONTROL_MC3_R2		(0x0844)
#define DQE0_HSC_CONTROL_MC4_R2		(0x0848)

#define DQE0_HSC_CONTROL_YCOMP		(0x084C)
 ...
 * P  -> _n: [0, 17]
 */
#define DQE0_HSC_LSC_GAIN_P(_n)		(0x0900 + ((_n) * 0x4))
#define DQE0_HSC_LSC_GAIN_P1(_n)	(0x0900 + ((_n) * 0x4))
#define DQE0_HSC_LSC_GAIN_P2(_n)	(0x0918 + ((_n) * 0x4))
#define DQE0_HSC_LSC_GAIN_P3(_n)	(0x0930 + ((_n) * 0x4))
 ...
 * P  -> _n: [0, 17]
 */
#define DQE0_HSC_LHC_GAIN_P(_n)		(0x0948 + ((_n) * 0x4))
#define DQE0_HSC_LHC_GAIN_P1(_n)	(0x0948 + ((_n) * 0x4))
#define DQE0_HSC_LHC_GAIN_P2(_n)	(0x0960 + ((_n) * 0x4))
#define DQE0_HSC_LHC_GAIN_P3(_n)	(0x0978 + ((_n) * 0x4))
 ...
 * P  -> _n: [0, 17]
 */
#define DQE0_HSC_LBC_GAIN_P(_n)		(0x0990 + ((_n) * 0x4))
#define DQE0_HSC_LBC_GAIN_P1(_n)	(0x0990 + ((_n) * 0x4))
#define DQE0_HSC_LBC_GAIN_P2(_n)	(0x09A8 + ((_n) * 0x4))
#define DQE0_HSC_LBC_GAIN_P3(_n)	(0x09C0 + ((_n) * 0x4))
 ...
 * S  -> _n: [0, 9]
 */
#define DQE0_HSC_POLY(_n)		(0x09D8 + ((_n) * 0x4))
#define DQE0_HSC_POLY_S(_n)		(0x09D8 + ((_n) * 0x4))
#define DQE0_HSC_POLY_B(_n)		(0x09EC + ((_n) * 0x4))
...
#define DQE0_GAMMA_MATRIX_CON		(0x0C00)
 ...
 */
#define DQE0_GAMMA_MATRIX_COEFF(_n)	(0x0C04 + ((_n) * 0x4))
#define DQE0_GAMMA_MATRIX_COEFF0	(0x0C04)
#define DQE0_GAMMA_MATRIX_COEFF1	(0x0C08)
#define DQE0_GAMMA_MATRIX_COEFF2	(0x0C0C)
#define DQE0_GAMMA_MATRIX_COEFF3	(0x0C10)
#define DQE0_GAMMA_MATRIX_COEFF4	(0x0C14)
...
#define DQE0_DEGAMMA_CON		(0x1000)
...
#define DQE0_LINEAR_MATRIX_CON		(0x1400)
 ...
 *     (20-21-22) : Reg3.L-Reg3.H-Reg4.L
 */
#define DQE0_LINEAR_MATRIX_COEFF(_n)	(0x1404 + ((_n) * 0x4))
#define DQE0_LINEAR_MATRIX_COEFF0	(0x1404)
#define DQE0_LINEAR_MATRIX_COEFF1	(0x1408)
#define DQE0_LINEAR_MATRIX_COEFF2	(0x140C)
#define DQE0_LINEAR_MATRIX_COEFF3	(0x1410)
#define DQE0_LINEAR_MATRIX_COEFF4	(0x1414)
...
#define DQE0_LINEAR_MATRIX_OFFSET0	(0x1418)
 ...
 * _n: [0, 2]
 */
#define DQE0_CGC_MC_R(_n)		(0x1804 + ((_n) * 0x4))
#define DQE0_CGC_MC_R0			(0x1804)
#define DQE0_CGC_MC_R1			(0x1808)
#define DQE0_CGC_MC_R2			(0x180C)
...
#define DQE0_REGAMMA_CON		(0x2000)
...
#define DQE0_CGC_DITHER			(0x2400)
#define DQE0_DISP_DITHER		(0x2800)
...
#define DQE0_HIST_WEIGHT_0		(0x300C)
...
#define DQE0_HIST_WEIGHT_1		(0x3010)
#define HIST_WEIGHT_B(_v)		((_v) << 0)
#define HIST_WEIGHT_B_MASK		(0x7FF << 0)

#define DQE0_HIST_THRESH		(0x3014)
 ...
 * _n: [0, 127] / _x: [0, 255]
 */
#define DQE0_HIST_BIN(_n)		(0x3400 + ((_n) * 0x4))
...
#define DQE0_SECURE_ROI_SECURITY	(0x3C00)
#define DQE_ROI_SECURITY		(0x1 << 0)

#define DQE0_SECURE_ROI_SIZE		(0x3C04)
...
#define DQE0_SECURE_ROI_START		(0x3C08)
...
#define DQE0_SECURE_ROI_CON		(0x3C0C)
 ...
 * _n: [0, 2456] / _x: [0, 4913]
 */
#define DQE0_CGC_LUT(_n)		(0x4000 + ((_n) * 0x4))
#define DQE0_CGC_LUT_R(_n)		(0x4000 + ((_n) * 0x4))
#define DQE0_CGC_LUT_G(_n)		(0x8000 + ((_n) * 0x4))
#define DQE0_CGC_LUT_B(_n)		(0xC000 + ((_n) * 0x4))
