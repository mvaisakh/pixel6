...
#define WLC_E_REASON_SBD_ENABLE	5
#define WLC_E_REASON_SBD_DISABLE	6
...
#define WLC_E_GTKKEYROT_SKIPCHANSW 1       /* Avoid chansw by test4 while gtk in progress */
...
typedef enum {
	...
	CHANSW_TEST1 = 21,	/* channel switch due to SBT aw */
	CHANSW_TEST2 = 22,	/* channel switch due to test2 */
	CHANSW_TEST3 = 23,	/* channel switch due to test3 */
	CHANSW_TEST4 = 24,	/* channel switch due to TEST2 */
	CHANSW_TEST5 = 25, /* channel switch due to test5 action frame */
