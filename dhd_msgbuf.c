...
#if defined(TX_STATUS_LATENCY_STATS) || defined(DEVICE_TX_STUCK_DETECT) || \
	defined(DHD_HP2P)
...
#ifdef DHD_HP2P
	/* Create HPP flow ring if HP2P is enabled and TID=7  and SBT interface */
